      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="prose prose-invert max-w-none">
          ...
          <article className="privacy-policy">
            <h1 className="text-center font-bold">Polityka Prywatności</h1>
            ...
            <p>Poniższa Polityka Prywatności jest integralną częścią <a href="https://www.vexelstudio.pl/">Regulaminu Serwisu</a>, który określa zasady, prawa i obowiązki Użytkowników korzystających z Serwisu.</p>

            <h2 className="text-center font-bold">§1 Definicje</h2>
            <ul>
                <li><p><strong>Serwis</strong> - serwis internetowy "Vexel Studio" działający pod adresem https://www.vexelstudio.pl/</p></li>
                ...
                <li><p><strong>Administrator Serwisu / Danych</strong> - Administratorem Serwisu oraz Administratorem Danych (dalej Administrator) jest osoba fizyczna "Jakub Tomczyk" zamieszkała w Bukowno, świadcząca usługi drogą elektroniczną za pośrednictwem Serwisu</p></li>
            ...
            <h2 className="text-center font-bold">§2 Inspektor Ochrony Danych</h2>
            ...
            <h2 className="text-center font-bold">§3 Rodzaje Plików Cookies</h2>
            <ul>
            ...
            <h2 className="text-center font-bold">§4 Bezpieczeństwo składowania danych</h2>
            <ul>
            ...
            <h2 className="text-center font-bold">§5 Cele do których wykorzystywane są pliki Cookie</h2>
            <ul id="cele">
            ...
            <h2 className="text-center font-bold">§6 Cele przetwarzania danych osobowych</h2>
            ...
            <h2 className="text-center font-bold">§7 Pliki Cookies Serwisów zewnętrznych</h2>
            ...
            <ul id="zewnetrzne">
                <li><strong>Usługi multimedialne:</strong><ul></ul></li>
                <li><strong>Usługi udostępniania treści:</strong><ul><li><a rel="nofollow external" href="https://help.instagram.com/519522125107875">Instagram</a></li></ul></li>
                <li><strong>Usługi Newslettera:</strong><ul><li><a rel="nofollow external" href="https://mailchimp.com/legal/privacy/">MailChimp</a></li></ul></li>
                <li><strong>Prowadzenie statystyk:</strong><ul><li><a rel="nofollow external" href="https://policies.google.com/privacy?hl=pl">Google Analytics</a></li></ul></li>
            </ul>
            ...
            <h2 className="text-center font-bold">§8 Rodzaje gromadzonych danych</h2>
            ...
            <h2 className="text-center font-bold">§9 Dostęp do danych osobowych przez podmioty trzecie</h2>
            ...
            <p>Administrator w celu prowadzenia serwisu korzysta z usług zewnętrznego dostawcy hostingu, VPS lub Serwerów Dedykowanych - <strong><a rel="nofollow external" href="https://home.pl/rodo/">home.pl SA</a></strong>. Wszelkie dane gromadzone i przetwarzane w serwisie są przechowywane i przetwarzane w infrastrukturze usługodawcy zlokalizowanej w Polsce. Istnieje możliwość dostępu do danych wskutek prac serwisowych realizowanych przez personel usługodawcy. Dostęp do tych danych reguluje umowa zawarta pomiędzy Administratorem a Usługodawcą.</p>
            <br />

            <h2 className="text-center font-bold">§10 Sposób przetwarzania danych osobowych</h2>
            ...
            <h2 className="text-center font-bold">§11 Podstawy prawne przetwarzania danych osobowych</h2>
            ...
            <h2 className="text-center font-bold">§12 Okres przetwarzania danych osobowych</h2>
            <p><strong>Dane osobowe podane dobrowolnie przez Użytkowników:</strong></p>
            ...
            <h2 className="text-center font-bold">§13 Prawa Użytkowników związane z przetwarzaniem danych osobowych</h2>
            <p>Serwis gromadzi i przetwarza dane Użytkowników na podstawie:</p>
            <ul>
            ...
            <h2 className="text-center font-bold">§14 Kontakt do Administratora</h2>
            <p>Z Administratorem można skontaktować się w jeden z poniższych sposobów</p>
            <ul>
                <li><p><strong>Adres poczty elektronicznej</strong> - kontakt@vexelstudio.pl</p></li>
                <li><p><strong>Połączenie telefoniczne</strong> - +48 514 524 327</p></li>
                <li><p><strong>Formularz kontaktowy</strong> - dostępny pod adresem: /kontakt</p></li>
            </ul>

            <h2 className="text-center font-bold">§15 Wymagania Serwisu</h2>
            <ul>
            ...
            <h2 className="text-center font-bold">§16 Linki zewnętrzne</h2>
            ...
            <h2 className="text-center font-bold">§17 Zmiany w Polityce Prywatności</h2>
            <ul>
